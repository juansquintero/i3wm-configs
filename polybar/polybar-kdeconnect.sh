...
COLOR_DISCONNECTED='#672C00'       # Device Disconnected (Brown)
COLOR_NEWDEVICE='#E1981D'          # New Device (Yellow Orangeshish)
COLOR_BATTERY_90='#2FD73E'         # Battery >= 90 (Green Brighter)
COLOR_BATTERY_80='#009F09'         # Battery >= 80 (Green Coold)
COLOR_BATTERY_70='#59A848'         # Battery >= 70 (Green Cute)
COLOR_BATTERY_60='#59A848'         # Battery >= 60 (Green Cute)
COLOR_BATTERY_50='#ED5007'         # Battery >= 50 (Orange Redish)
COLOR_BATTERY_LOW='#A71100'        # Battery <  50 (Redish)
